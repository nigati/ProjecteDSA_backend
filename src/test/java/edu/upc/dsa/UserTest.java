...
public class UserTest {
    ...
    UserManagerDAO myUserManager;

    @Before
    public void setUp() throws Exception{
        this.myUserManager = UserManagerDAOImpl.getInstance();
    }
    ...
    public void testLogin() throws Exception {
        ...
        User gilbert1= myUserManager.login(new LogInParams("Gilbert","guapo1"));
        Assert.assertEquals(null, gilbert1);
        User gilbert= myUserManager.login(new LogInParams("Gilbert","guapo"));
